...
<body>
    ...
    <header class="bg-gradient">
        <div class="container px-4 text-center">
            <br>
            <h1 class="fw-bolder" id="label-title">Tạo tài khoản dành cho nhà tuyển dụng</h1>
            <p class="font-weight-bold" id="label-title" style="color: #451da0 !important;">Cùng tạo dựng lợi thế cho doanh nghiệp bằng trải nghiệm
                công nghệ tuyển dụng ứng dụng sâu</p>
        </div>
    </header>
    <section class="">
        <!-- Jumbotron -->
                                ...
                                Bằng việc đăng ký tài khoản, bạn đã đồng ý với <span class="text-highlight">Điều khoản dịch vụ</span> và <span class="text-highlight">Chính sách bảo
                                    mật</span> của chúng tôi
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2"></div>
                                            <div class="col-lg-2">
                                                <button type="reset" class="btn btn-reset btn-block mb-4">Nhập
                                                    lại</button>
                                            </div>
                                            <div class="col-lg-2">
