...
<div class="list-job">
    <div class="job-header">
        <span>Tìm thấy <b class="text-highlight">{{count($result)}}</b> việc làm phù hợp với yêu cầu của bạn.</span>
    </div>
    ...
    <div class="job-body row">
        <div class="col-md-9">
            ...
            <div class="job-item  bg-highlight  job-ta result-job-hover" data-job-id="886513" data-job-position="1" data-box="BoxSearchResult">
                    <div class="avatar">
                        <a target="_blank" href="https://www.topcv.vn/viec-lam/nhan-vien-ky-thuat-bao-tri-dien/886513.html?ta_source=JobSearchList" class="company-logo" rel="nooppener noreferrer">
                    ...
                    <div class="body">
                        <div class="content">
                            <div class="ml-auto">
                                <h3 class="title">
                                    <a target="_blank" class="underline-box-job" href="https://www.topcv.vn/viec-lam/nhan-vien-ky-thuat-bao-tri-dien/886513.html?ta_source=JobSearchList" rel="nooppener noreferrer">
                                ...
                                <p class="company underline-box-job">
                                    <a href="https://www.topcv.vn/cong-ty/cong-ty-tnhh-kcc-viet-nam-nhon-trach/128012.html" data-toggle="tooltip" title="" data-placement="top" data-container="body" target="_blank" rel="nooppener noreferrer" data-original-title="CÔNG TY TNHH KCC (VIỆT NAM NHƠN TRẠCH">CÔNG TY TNHH KCC (VIỆT NAM NHƠN TRẠCH</a>
                                </p>
                            </div>
