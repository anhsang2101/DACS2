                            ...
                            <div class="col-md-4 col-sm-6 feature-job job-ta">
                                <div class="feature-job-item">
                                    <div class="cvo-flex"><a href="/ap/detail-job/{{ $item->id }}" target="_blank" tabindex="-1">
                                            <div class="box-company-logo"><img title="" alt="CÔNG TY CỔ PHẦN CÔNG NGHỆ &amp; SÁNG TẠO TRẺ TEKY HOLDINGS tuyển dụng tại TopCV" src="{{asset('/img/logo/' .$item->image)}}" class="img-responsive"></div>
                                        </a>
