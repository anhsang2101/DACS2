                            ...
                            <div class="col-md-4 col-sm-6 feature-job job-ta">
                                <div class="feature-job-item">
                                    <div class="cvo-flex"><a href="/ap/detail-job/{{ $item->id }}" target="_blank" tabindex="-1">
                                        ...
                                        <div class="col-like"><button onclick="addfvr(this.id)" id=" {{ $item->id }}" data-id="69610" tabindex="-1"><i class="fa-regular fa-heart icon-first" id="like{{ $item->id }}"></i> <i class="fa-solid fa-heart icon-last" id="unlike{{ $item->id }}"></i></button>
                                        </div>
                                    </div>
